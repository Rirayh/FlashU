...
from utils import get_config, denorm, get_hyper_params, path_to_llm_name, load_state_dict, save_images_as_grid
...
if __name__ == '__main__':
    ...
    with open(validation_prompts_file) as fp:
        ...
        logger.info(f"Running on {len(validation_prompts)} prompts.")
